...
::: tip 唯一终结者
`approval/request` 以 `{prepend:true, global:true}` 注册（<span class="lnum">index.ts:L2398</span>，options 行 <span class="lnum">index.ts:L2813</span>）—— 对命中的 ask，本插件就是最终裁决，不会开第二个弹窗、不会双写、不会让审计断裂。
:::