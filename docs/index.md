...
|---|---|---|---|---|---|
| `5 / 8 / 10 s` | `3 \| 20` | `8 s` · `5/8/10s` | `4,000` | `16 条`（无 RPC） | `200 条 / 5000 行` |
...
<div class="navgrid">
  ...
  <a class="navcard" href="/dsh-auto-approval-llm/12-config"><span class="nn">12</span><span class="nt">配置全景</span><span class="nd">58 键 schema + bundle 覆盖</span></a>
...
<div class="navgrid">
  ...
  <a class="navcard" href="/dsh-auto-approval-llm/15-quality"><span class="nn">15</span><span class="nt">质量保障体系</span><span class="nd">1865 测试 + 运行时验证</span></a>
