...
export const DEFAULT_ALLOW_TOOL_GROUPS: ReadonlyArray<{ label: string; tools: readonly string[] }> = [
  ...
  {
    label: 'Orchestration',
    tools: ['subagent', 'workflow', 'ralph', 'spawn_agent', 'spawn_teammate', 'send_message', 'wait_agent', 'list_agents', 'interrupt_agent', 'read_thread', 'wait_threads'],
  },
]
...
export const THRESHOLD_DEFAULTS = {
   ...
   * thinking + the final answer — 256 starved the JSON answer). */
