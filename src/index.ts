...
import { appendAuditLine } from './auto/audit.js'
import { AGGRESSIVE_BUILTIN, applyCategoryDirective, categoryDirectiveFor, type CategoryKey, LOCKED_CATEGORIES } from './auto/category.js'
...
import {
  type RaceHumanHandle,
  type ReviewResult,
  type StaticRisk,
  AWAITING_MARKER,
  EDITABLE_CONFIG_KEYS,
  LOCKED_ASK_MARKER,
  REVIEW_TIMEOUT_NOTICE,
  applyBreaker,
  approvalSource,
  assembleReviewerSystem,
  breakerNote,
  breakerTripped,
  buildAskReason,
  createKeyedMutex,
  ...
  followResolution,
  formatDenyFeedback,
  lowRiskReviewOutcome,
  stripCountdownMarkers,
  unattendedMustFailClosed,
  plainConfigValue,
  raceHumanDecision,
  reviewSuggestionNote,
  reviewerAutoAllowBlocked,
  riskFromAssessment,
  staticListDecision,
} from './auto/decision.js'
import { pushLatencySample } from './auto/latency.js'
...
} from './auto/permission-change.js'
import {
...
import { normalizePath, resolveRoots, devZoneRootsFor } from './auto/paths.js'
import { assessTool, structuredRuntimeStateReadHits } from './auto/policy.js'
...
import { setRuntimeStateDir } from './auto/runtime-paths.js'
import { runtimeStateReadHits } from './auto/shell.js'
import { isTrustedFetchRequest } from './auto/trust.js'
import { normalizeLane } from './auto/model-channel.js'
import { resolveConfig } from './auto/config-normalize.js'
import { currentPreset, findToolCallArguments, resolveModelRoute, riskTimedOutAction } from './auto/session-introspect.js'
...
import { json, resolveTrustedHosts, setTrustedHosts, trustedHosts } from './auto/http-pipeline.js'
import {
  holdWhile,
  installFeedbackRoute,
  installHistoryRoute,
  installLatencyRoute,
  installLearningStoreRoute,
  installLlmCatalogRoutes,
  installRevealRoute,
  installReviewerCredentialRoute,
  installReviewStatusRoute,
  installSessionModeRoute,
  installSessionReviewStatusRoute,
  installSettingsRoute,
  installTestRoute,
  installToolStatsRoute,
  setFactoryConfigDefaults,
} from './auto/route-installers.js'
import {
...
import {
  buildRejectGuidanceText,
  markFirstAutoSessionNotice,
  maybeInjectRejectGuidance,
  onboardingNoticeText,
  queueNotice,
  watchNotices,
} from './auto/notices.js'
import { resolveReviewerApiKey, reviewerRouteAvailable, reviewWithLLM } from './auto/review-pipeline.js'
import { auditMaskFailed, auditRedact, recordDecisionFeedback, recordTimeoutFeedback, sweepFeedback } from './auto/feedback-maps.js'
import { pushHistory } from './auto/approval-history.js'
import {
  debugLog,
  denyOnAuditFailure,
  directHumanTargetRefusal,
  guardDenyDecision,
  nameChannelLockRefusal,
  reportRulesParseErrors,
} from './auto/debug-and-decisions.js'
...
export { buildReviewSnapshot, reviewerRouteAvailable } from './auto/review-pipeline.js'
...
// The offer predicate compares a declaration against the factory defaults;
// the schema it resolves from lives here, so the route module cannot import
// it without a cycle. Hand the value over once, before apply() runs.
setFactoryConfigDefaults(FACTORY_CONFIG_DEFAULTS)
