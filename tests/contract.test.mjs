...
// ── client approval watcher ───────────────────────────────────────────────
// The watcher binds to uiSession.pendingInteractions when the plugin applies
// (the service is a declared inject dependency, so there is no probe window to
// outlast). Its contract lives in tests/client-declarative-services.test.mjs.
